    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const response = await axios.post(REGISTER_URL,
            JSON.stringify({ user, firstName , lastName  , pwd }),
            {
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <label className="form-label" htmlFor="form3Example3cg">First Name:</label>
                         <input  type="text"
                            ...
                            <p id="uidnote" className={firstNameFocus && firstName && !validfirstName ? "instructions" : "offscreen"}>  4 to 24 characters.<br />
                            Must begin with a letter.<br />
                            Letters, numbers, underscores, hyphens allowed.
                         </p>
                      ...
                      <label className="form-label" htmlFor="lastName">Last Name:</label> 
                        <input  type="text"
                            ...
                            <p id="uidnote" className={lastNameFocus && lastName && !validlastName ? "instructions" : "offscreen"}>  4 to 24 characters.<br />
                            Must begin with a letter.<br />
                            Letters, numbers, underscores, hyphens allowed.
                         </p>
